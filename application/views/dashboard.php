            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="small-box bg-info">
                        ...
                        <a href="<?php echo site_url('laporan_penjualan') ?>" class="small-box-footer"> More Info <i class="fas fa-arrow-circle-right"></i> </a>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="small-box bg-danger">
                        ...
                        <a href="<?php echo site_url('laporan_stok_masuk') ?>" class="small-box-footer"> More Info <i class="fas fa-arrow-circle-right"></i> </a>
                    </div>
                </div>
                <div class="col-12">
